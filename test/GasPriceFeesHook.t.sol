...
contract TestGasPriceFeesHook is Test, Deployers {
    ...
    function setUp() public {
        ...
        // New cheatcode from Foundry that allows us to update the gas price for calls that occur after
        // Default gas price will be 10 in our functions because this is in the setup
